...
The most interesting property of this pattern is that the tool used to build domain applications IS a domain application. ainative is itself a configuration of its own primitives, pointed at the domain of "agent workspace management."
