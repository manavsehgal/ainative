...
Built-in documentation and adoption tracking system that surfaces product guides, feature reference articles, and guided learning journeys directly within the `ainative-business` workspace. The User Guide includes a feature adoption tracker that shows your usage progress across all feature areas, four persona-based learning journeys, and a browsable feature exploration grid.
...
A visual tracker at the top of the page shows your adoption depth across all major feature areas. As you use different parts of `ainative-business`, the tracker updates to reflect which features you have explored and which remain undiscovered.

### Guided Learning Journeys
Four persona-based journeys walk you through `ainative-business` at your own pace:
...
2. Follow the step-by-step guide, which links directly to the relevant pages in `ainative-business`.
